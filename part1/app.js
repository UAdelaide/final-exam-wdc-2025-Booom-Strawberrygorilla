...
app.get('/api/walkrequests/open', async (req, res) => {
    try{
        const [rows] = await db.execute(
            `SELECT r.request_id, d_name AS dog_name, r.requested_time, r.duration_minutes, u.usernames AS owner_username
            FROM WalkRequests r
